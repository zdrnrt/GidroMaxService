...
const Process = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Удобно для вас время сотрудник МАКС Строй Сервис посетит объект для оценки технического состояния',
    ...
    },
    {
      ...
      description: 'Бригада специалистов МАКС Строй Сервис оперативно осуществит работы на объекте',
