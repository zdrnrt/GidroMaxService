...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ['Силиконовые пропитки', 'Акриловые составы', 'Органосиликаты', 'Долгосрочная защита', 'Гарантия 7 лет'],
    ...
    },
    {
      ...
      features: ['Мембранная кровля', 'Рулонные покрытия', 'Мастичная изоляция', 'Аварийный ремонт', 'Гарантия 7 лет'],
